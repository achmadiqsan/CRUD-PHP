...
<body>
    ...
    <main>
        <div class="container text-center">
            <!-- code untuk membuat halaman header nya starts -->
            <h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-swatchbook"></i>Book Strore</h1>
            <!-- code untuk membuat halaman header nya ends -->

            <!-- code untuk membuat inputannya starts-->
            ...
            <!-- code untuk membuat inputannya ends -->
